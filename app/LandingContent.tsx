    ...
    <>
      ...
      <div className="modal-backdrop" id="modal">
        <div className="modal-box">
          ...
          <a href="https://chat.whatsapp.com/EG043BDH6t48XHP8dWmX0L?mode=gi_t" className="modal-btn" target="_blank" rel="noopener noreferrer">
      ...
      <script dangerouslySetInnerHTML={{ __html: `
        ...
        document.getElementById('ctaMain')?.addEventListener('click', openModal);
        document.getElementById('ctaFinal')?.addEventListener('click', openModal);
        document.getElementById('ctaMobile')?.addEventListener('click', openModal);
