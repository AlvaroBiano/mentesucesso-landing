    ...
    <>
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <a href="https://chat.whatsapp.com/EG043BDH6t48XHP8dWmX0L?mode=gi_t" target="_blank" rel="noopener noreferrer" className="cta-btn">
...
<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
      ...
      <section className="section pain-section">
        ...
        <div className="pain-grid">
          {[
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>, title: 'Dinheiro evapora', text: 'Você recebe, planeja, mas no final do mês não sabe onde foi o dinheiro. Isso não é azar. É padrão. É o seu cérebro funcionando no automático. Seu cérebro está programado para eliminar tudo que exceda seu pivô financeiro.' },
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><path d="M9.5 2A2.5 2.5 0 017 4.5v.5H4a1 1 0 000 2h.5V9a2 2 0 002 2h1a2 2 0 002-2v-2h.5a1 1 0 000-2H13a2.5 2.5 0 01-2.5-2.5h-.5v-.5A2.5 2.5 0 019.5 2z"/><path d="M9 12.5v.5M9 15.5v.5M9 18.5v.5"/></svg>, title: 'Estresse reduz seu QI', text: 'Estresse financeiro crônico não é só um sentimento — ele reduz sua função cognitiva em até 13 pontos de QI. Você fica mais limitado justamente quando mais precisa pensar com clareza.' },
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 014-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 01-4 4H3"/></svg>, title: 'Rodа de ratos infinita', text: 'Quanto mais você mergulha no desespero financeiro, mais seu cérebro trava. As ideias evaporam, o planejamento some, e você fica completamente imobilizado.' },
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg>, title: 'Bloqueio inconsciente', text: 'Roteiros inconscientes, traumas somatizados e padrões gravados no sistema nervoso autônomo ditam sua capacidade de gerar e reter riqueza. Não é mentalização vazia. É neurociência.' },
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><path d="M12 3v18M3 9l4-6h10l4 6M3 9l4 6H3M21 9l-4 6h8"/></svg>, title: 'Medo do dinheiro', text: 'Você sobrevive com o dinheiro que tem — e teme qualquer mudança que ultrapasse esse patamar. A ideia de ganhar mais gera desconforto, não vontade de agir. É o pivô financeiro funcionando — e trabalhando contra você.' },
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="26" height="26"><path d="M3 3v18h18"/><path d="M18 9l-5 5-4-4-6 6"/></svg>, title: 'Confunde pobreza com simplicidade', text: 'Pobreza e simplicidade não são a mesma coisa. Mas quando você olha para quem tem menos e chama de "simples", está treinando sua mente a rejeitar a prosperidade. A prosperidade não vai chegar se você tratar riqueza como se fosse inimiga.' },
          ].map((card, i) => (
      ...
      <section className="section science-section">
        ...
        <div className="science-cards">
          {[
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="30" height="30"><path d="M2 12C2 12 5 5 12 5s10 7 10 7-3 7-10 7S2 12 2 12z"/><circle cx="12" cy="12" r="3"/><path d="M12 5V3M12 19v2M5 12H3M19 12h2"/></svg>, title: 'Infraestrutura Biopsicológica', desc: 'Seus padrões financeiros não são escolhas racionais — são rotas neurais instaladas ao longo de décadas de condicionamento familiar e experiências acumuladas. Você não escolheu esses padrões. Você os herdou.' },
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="30" height="30"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>, title: 'Sistema Nervoso Autônomo', desc: 'Seus padrões com dinheiro estão gravados no sistema que você não controla conscientemente. Mudá-los exige estratégia estruturada, não só força de vontade.' },
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="30" height="30"><path d="M3 3v18h18"/><path d="M18 9l-5 5-4-4-6 6"/></svg>, title: 'Estresse Crônico = Menor QI', desc: 'Estresse financeiro persistente literalmente reduz sua capacidade cognitiva em até 13 pontos — e isso te impede ainda mais de sair do ciclo vicioso.' },
          ].map((card, i) => (
      ...
      <section className="cta-section">
        <div className="cta-content reveal">
          ...
          <a href="https://chat.whatsapp.com/EG043BDH6t48XHP8dWmX0L?mode=gi_t" target="_blank" rel="noopener noreferrer" className="cta-btn-large">
      ...
      <div className="whatsapp-bar">
        <a href="https://chat.whatsapp.com/EG043BDH6t48XHP8dWmX0L?mode=gi_t" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
